...
if __name__ == '__main__':
    ...
    for file in os.listdir(tamp_root):
        if not (mask_root/(os.path.splitext(file)[0]+"_gt.png")).is_file():
            stupid_files.append(file)
            continue
        '''if file in ['Tp_D_NRD_S_B_ani20002_nat20042_02437.tif', 'Tp_D_CNN_M_N_nat00090_nat00090_10575.jpg']:
